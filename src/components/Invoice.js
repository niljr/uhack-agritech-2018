...
import { Button, Header, Input, Table, Icon, Dropdown } from 'semantic-ui-react';
...
export default class Invoice extends PureComponent {
    ...
    handleChange = (value) => {
        const newInput = this.props.data.find(input => value === input.description);
    ...
    render() {
        const data = this.props.data.map(input => input.description);
            ...
            <Table basic='very' striped>
                ...
                <Table.Body>
                    <Table.Row>
                        <Table.Cell>
                            <Input
                                label={{ basic: true, content: isNewInput ? newInput.unit : '--' }}
                                disabled={!isNewInput}
                                type='number'
                                labelPosition='right'
